...
@Repository
public interface ProfesorRepository extends PagingAndSortingRepository<Profesor, Integer>, JpaSpecificationExecutor<Profesor>, CrudRepository<Profesor, Integer> {
